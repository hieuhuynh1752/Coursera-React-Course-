                    ...
                    <div className="container">
                        <div className="row row-header">
                            <div className="col-12 col-sm-6">
                                ...
                                <p>We take inspiration from the World's best cuisines, and create a unique fusion experience. Our lipsmacking creations will tickl your culinary senses!</p>
                ...
                <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
                    ...
                    <ModalBody>
                        <Form onSubmit={this.handleLogin}>
                            ...
                            <FormGroup check>
                                <Label check>
                                    <Input innerRef={(input)=>this.remember = input} type="checkbox" id="remember" name="remember"></Input>
                                    Remember me!
                                </Label>
                            </FormGroup>
